...
#This script creates some temporary file and folder (C:\deleteit) which will be deleted when script completes.
...
if not os.path.exists(r"C:\deleteit"):
    os.mkdir(r"C:\deleteit")
env.workspace = r"C:\deleteit"
arcpy.env.overwriteOutput =True
...
distance = r"C:\deleteit\distance.dbf"
